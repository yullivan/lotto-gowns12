...
public class Output {
    ...
    public static void purchasePriceOutput(PurchasePrice purchasePrice){
        System.out.println(purchasePrice.getPrice()+"원");
    }
    ...
    public static void LottoNumbersListOutput(LottoNumbersList lottoNumbersList, Count purchaseCount){
        if (purchaseCount.getAutoCount()>0){
            lottoNumbersList.getLottoNumbersList().addAll(new LottoNumbersList(true,purchaseCount).getLottoNumbersList());
        }
